...
export type ExperimentObservationRow = PublicTables["experiment_observations"]["Row"];
export type ExperimentObservationInsert = PublicTables["experiment_observations"]["Insert"];
export type ExperimentTransitionRow = PublicTables["experiment_transitions"]["Row"];
